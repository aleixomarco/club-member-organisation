...
function PollManagerPanel({ polls, setPolls, clubId, onAnlegen, onUmschalten }) {
  ...
  const create = async () => {
    ...
    if (supabase && clubId) supabase.rpc("notify_club", { target_club: clubId, p_notif_type: "polls", p_title: t("umf.neuAnlegen"), p_body: title.trim() });
    setTitle(""); setOptions(["",""]);
  };
