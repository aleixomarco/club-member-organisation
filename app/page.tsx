...
const INITIAL_MEMBERS = [
  ...
  { id: "m3", clubId: DEMO_CLUB_ID, name: "Sergio Pereira", email: "sergio@cmo.app", password: "demo", team: "Eltern / Angehörige", managedTeam: "U11", number: null, since: 2023, roles: ["eltern", "teammanager", "mitglied"], color: C.green, points: 120, tippPoints: 5, badges: [], birthdate: "1985-09-14", familyId: "fam-thomas", familyRole: "eltern" },
...
function TeamPenaltyCatalog({ user }) {
  ...
  const assignPenalty = async (event) => {
    event.preventDefault();
    if (!assignPlayerId || !assignRuleId) { setMessage("Bitte Spieler und Strafe auswählen."); return; }
