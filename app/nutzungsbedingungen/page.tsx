...
import { FREIE_ZUGAENGE } from "@/lib/preise";
...
export default function TermsPage() { return <LegalShell title="Nutzungsbedingungen">
  ...
  <h2>Vollzugang für Vereine</h2>
  <p>Der Verein zahlt nach der Zahl der Zugänge. Als Zugang zählt jedes selbst angemeldete Konto. Wer ohne eigenen Zugang eingetragen wird — etwa ein Kind, das ein Elternteil anlegt —, zählt nicht mit.</p>
  <p>Den Vollzugang fragt die Vereinsleitung an. Wir unterbreiten daraufhin ein Angebot, das sich nach der Zahl der benötigten Zugänge richtet, und stellen dem Verein eine Rechnung. Mit dem Zahlungseingang wird der Verein freigeschaltet.</p>
  <p>Vertragspartner ist der Verein, nicht die einzelne Person, die die Anfrage stellt. Wechselt die Vereinsleitung, bleibt der Vollzugang beim Verein.</p>
  <p>Alle Preise verstehen sich zuzüglich der gesetzlichen Umsatzsteuer, sofern im Angebot nicht anders ausgewiesen. Die Laufzeit ergibt sich aus dem Angebot und verlängert sich, sofern dort vereinbart, um den jeweiligen Zeitraum, wenn nicht rechtzeitig gekündigt wird.</p>
  ...
  <h2>Was der Vollzugang freischaltet</h2>
  <p>Mannschaftsverwaltung, Chat, Vereins-News, Fahrzeugbuchung, Helferdienst, Tippspiel, Wahl zur Athletin oder zum Athleten der Saison, Kalender-Abonnement und Vereins-Events. Ohne Vollzugang bleiben die Termine des Vereins — Trainings und Spiele — dauerhaft nutzbar, jeweils passend zur Rolle des Mitglieds.</p>
  ...
  <p>Die Abrechnung erfolgt auf Rechnung an den Verein. In der App findet keine Zahlung statt.</p>

  <h2>Kündigung</h2>
  <p>Der Verein kann den Vollzugang zum Ende der vereinbarten Laufzeit kündigen; die Frist ergibt sich aus dem Angebot. Eine Kündigung genügt in Textform an die im Impressum genannte Adresse.</p>
  <p>Nach dem Ende bleibt der Verein mit der kostenlosen Stufe nutzbar. Die Daten des Vereins bleiben zunächst erhalten; Näheres regelt der Abschnitt zur Speicherdauer in der Datenschutzerklärung.</p>
